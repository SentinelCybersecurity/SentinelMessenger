...
buildscript {
  ...
  dependencies {
    ...
    // SENTINEL: wire-handler factory now in buildSrc, no manual classpath needed
...
// SENTINEL: Limit concurrency of high-RAM tasks to avoid OOMs (especially in CI)
...
// SENTINEL: Add task `./gradlew allDeps` to list all dependencies for each configuration
allprojects {
