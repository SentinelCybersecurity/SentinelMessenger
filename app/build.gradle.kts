...
val canonicalVersionCode = 251220 // alias: 251220 // alias: 1625
val canonicalVersionName = "25.12.20" // alias: "25.12.20" // alias: "7.66.5"
...
android {
  ...
  productFlavors {
    create("store") {
      ...
      buildConfigField("boolean", "MANAGES_SENTINEL_UPDATES", "false")
    }

    create("website") {
      dimension = "distribution"
      isDefault = true
      buildConfigField("boolean", "MANAGES_SENTINEL_UPDATES", "true")
    }
  ...
  androidComponents {
    beforeVariants { variant ->
      ...
      if (isSelected && matchesBuild) {
        // SENTINEL: Disable unit tests for non-debug builds
...
dependencies {
  ...
  implementation(libs.sentinel.ringrtc)
