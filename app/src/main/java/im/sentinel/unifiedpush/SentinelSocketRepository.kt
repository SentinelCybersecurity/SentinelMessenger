...
object SentinelSocketRepository {

  private val TAG = Log.tag(SentinelSocketRepository::class)

  private val MEDIA_TYPE_JSON = "application/json; charset=utf-8".toMediaType()

  private const val DEVICE_NAME = "SentinelSocket"

  @Throws(IOException::class, DeviceLimitExceededException::class)
  fun createDevice(): SentinelSocketDevice {
    Log.d(TAG, "Creating device for SentinelSocket")
  ...
  /**
   * We need to load prekeys, else we get a bug if SentinelSocket is the only linked device:
