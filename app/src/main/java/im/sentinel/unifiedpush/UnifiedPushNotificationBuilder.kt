...
class UnifiedPushNotificationBuilder(val context: Context) {
  ...
  fun setNotificationDeviceLimitExceeded(deviceLimit: Int) {
    notify(NOTIFICATION_ID, context.getString(R.string.UnifiedPushNotificationBuilder__sentinelsocket_device_limit_hit, deviceLimit - 1))
  }


  fun setNotificationSentinelSocketForbiddenEndpoint() {
    notify(NOTIFICATION_ID, context.getString(R.string.UnifiedPushNotificationBuilder__sentinelsocket_forbidden_endpoint))
  }

  fun setNotificationSentinelSocketForbiddenUuid() {
    notify(NOTIFICATION_ID, context.getString(R.string.UnifiedPushNotificationBuilder__sentinelsocket_forbidden_uuid))
  }

  fun setNotificationSentinelSocketForbiddenPassword() {
    notify(NOTIFICATION_ID, context.getString(R.string.UnifiedPushNotificationBuilder__sentinelsocket_forbidden_password))
  }
