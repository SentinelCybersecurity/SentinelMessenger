...
data class SentinelSocketDevice(
  val deviceId: Int,
  val password: String,
) {
  override fun toString(): String {
    return "SentinelSocketDevice:$deviceId"
  }
}
...
enum class RegistrationStatus(val value: Int) {
  ...
  BAD_RESPONSE(3),
  SERVER_ERROR(4),
  /** The UUID is forbidden by the config of SentinelSocket */
  FORBIDDEN_UUID(5),
  /** The endpoint is forbidden by the config of SentinelSocket */
