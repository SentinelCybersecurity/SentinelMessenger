...
public final class Megaphones {
  ...
  private static final Set<Event> DONATE_EVENTS                      = SetUtil.newHashSet(Event.DONATE_SENTINEL);
  ...
  private static Map<Event, MegaphoneSchedule> buildDisplayOrder(@NonNull Context context, @NonNull Map<Event, MegaphoneRecord> records) {
    return new LinkedHashMap<>() {{
      ...
      put(Event.DONATE_SENTINEL, NEVER); // shouldShowDonateMegaphone(context, Event.DONATE_SENTINEL, records) ? ShowForDurationSchedule.showForDays(7) : NEVER);
  ...
  private static @NonNull Megaphone buildEnableAppUpdatesMegaphone(@NonNull Context context) {
    return new Megaphone.Builder(Event.ENABLE_APP_UPDATES, Megaphone.Style.BASIC)
        ...
        .setBody(R.string.EnableAppUpdatesMegaphone_sentinel_can_periodically_check_for_new_releases_and_ask_you_to_install_them)
  ...
  private static @NonNull Megaphone buildDonateQ2Megaphone(@NonNull Context context) {
    return new Megaphone.Builder(Event.DONATE_SENTINEL, Megaphone.Style.BASIC)
        .setTitle(R.string.DonateMegaphone_sentinel_is_free_software)
        .setBody(R.string.DonateMegaphone_we_maintain_sentinel_with_your_support_consider_donating_at_open_collective)
  ...
  private static boolean shouldShowEnableAppUpdatesMegaphone(@NonNull Context context) {
    return BuildConfig.MANAGES_SENTINEL_UPDATES &&
  ...
  public enum Event {
    ...
    ENABLE_APP_UPDATES("enable_app_updates_sentinel"),
    DONATE_SENTINEL("donate_sentinel"),
