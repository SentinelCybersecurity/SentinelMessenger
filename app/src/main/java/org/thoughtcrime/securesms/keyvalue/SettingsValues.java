...
public final class SettingsValues extends SignalStoreValues {
  ...
  private static final String SENTINEL_NOTIFICATION_METHOD               = "sentinel.notificationMethod";
  ...
  void onFirstEverAppLaunch() {
    ...
    // SENTINEL: These settings are saved in shared prefs too. Sync with the stored values.
  ...
  public void setTheme(@NonNull Theme theme, boolean useDynamicColors) {
    ...
    // SENTINEL: Store the value unencrypted to be able to read it back when app is locked
  ...
  public void setLanguage(@NonNull String language) {
    // SENTINEL: Keep language setting in SharedPreferences
  ...
  public NotificationDeliveryMethod getPreferredNotificationMethod() {
    ...
    if (getStore().containsKey(SENTINEL_NOTIFICATION_METHOD)) {
      method = NotificationDeliveryMethod.deserialize(
          getString(SENTINEL_NOTIFICATION_METHOD, NotificationDeliveryMethod.FCM.serialize())
      );
    } else {
  ...
  public void setPreferredNotificationMethod(NotificationDeliveryMethod method) {
    putString(SENTINEL_NOTIFICATION_METHOD, method.serialize());
  }
