...
fun LearnMoreSheet() {
  ...
  val fullString = stringResource(id = R.string.LinkDeviceFragment__for_android_devices_visit_s_to_install_sentinel, linkText)
  ...
  return Column(
    ...
    Text(
      ...
      text = stringResource(R.string.LinkDeviceFragment__sentinel_on_another_device),
    ...
    LinkedDeviceInformationRow(
      ...
      stringResource(R.string.LinkDeviceFragment__sentinel_supports_linking_to_other_android_devices)
    )
