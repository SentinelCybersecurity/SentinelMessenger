...
public final class JobManagerFactories {
  ...
  public static Map<String, Job.Factory> getJobFactories(@NonNull Application application) {
    return new HashMap<>() {{
      ...
      put("AllDataSyncRequestJob",                     new FailingJob.Factory()); // SENTINEL
      ...
      put("CallQualitySurveySubmission",               new FailingJob.Factory()); // SENTINEL
      ...
      put(UnifiedPushRefreshJob.KEY,                   new UnifiedPushRefreshJob.Factory());  // SENTINEL
      ...
      put("InAppPaymentGiftSendJob",                   new FailingJob.Factory()); // SENTINEL
      ...
      put("MultiDeviceOutgoingPaymentSyncJob",         new FailingJob.Factory()); // SENTINEL
      ...
      put("PaymentLedgerUpdateJob",                    new FailingJob.Factory()); // SENTINEL
      put("PaymentNotificationSendJob",                new FailingJob.Factory()); // SENTINEL
      put("PaymentNotificationSendJobV2",              new FailingJob.Factory()); // SENTINEL
      put("PaymentSendJob",                            new FailingJob.Factory()); // SENTINEL
      put("PaymentTransactionCheckJob",                new FailingJob.Factory()); // SENTINEL
      ...
      put("SendPaymentsActivatedJob",                  new FailingJob.Factory()); // SENTINEL
      ...
      put("AvatarMigrationJob",                           new FailingJob.Factory());  // SENTINEL
      ...
      put("CachedAttachmentsMigrationJob",                new FailingJob.Factory());  // SENTINEL
      ...
      put("LegacyMigrationJob",                           new FailingJob.Factory());  // SENTINEL
      ...
      put("RecheckPaymentsMigrationJob",                  new FailingJob.Factory());  // SENTINEL
      put(ReleaseChannelRecipientFixMigrationJob.KEY,     new ReleaseChannelRecipientFixMigrationJob.Factory());
      put("RecipientSearchMigrationJob",                  new FailingJob.Factory());  // SENTINEL
      put("ResetArchiveTierMigrationJob",                 new FailingJob.Factory());  // SENTINEL
      put(SelfRegisteredStateMigrationJob.KEY,            new SelfRegisteredStateMigrationJob.Factory());
      put("StickerLaunchMigrationJob",                    new FailingJob.Factory());  // SENTINEL
      ...
      put("UuidMigrationJob",                             new FailingJob.Factory());  // SENTINEL
