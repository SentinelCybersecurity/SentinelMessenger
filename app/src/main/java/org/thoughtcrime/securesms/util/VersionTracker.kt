...
object VersionTracker {
  ...
  @JvmStatic
  fun getLastSeenVersionForSentinel(context: Context): Int {
    return TextSecurePreferences.getLastVersionCodeForSentinel(context)
  }

  @JvmStatic
  fun updateLastSeenVersion(context: Context) {
    val currentVersionCode = BuildConfig.VERSION_CODE
    val lastVersionCode = TextSecurePreferences.getLastVersionCodeForSentinel(context)
    ...
    TextSecurePreferences.setLastVersionCodeForSentinel(context, currentVersionCode)
  }
