...
class LinkPreviewUtilTest_findValidPreviewUrls {
  ...
  @Test
  fun contains_a_link() {
    val links = LinkPreviewUtil.findValidPreviewUrls("https://%73%69%67%6E%61%6C.%6F%72%67")

    Assert.assertEquals(1, links.size().toLong())

    Assert.assertTrue(links.containsUrl("https://%73%69%67%6E%61%6C.%6F%72%67"))
  }
  ...
  fun does_not_contain_link() {
    ...
    Assert.assertFalse(links.containsUrl("https://%73%69%67%6E%61%6C.%6F%72%67/page"))
  }

  @Test
  fun contains_two_links() {
    val links = LinkPreviewUtil.findValidPreviewUrls("Links https://%73%69%67%6E%61%6C.%6F%72%67 https://android.com")
